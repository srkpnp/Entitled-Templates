...
;(function ( $, window, document, undefined ) {
    ...
    // The lbg Gauge constructor
    function lbgGauge(element, options , method) {
        // This
        var _this = this;
    ...
    $.fn.lbgGauge = function ( method, options ) {
        var _method = method,
        ...
        if (typeof _method !== 'string') {
            if (_arguments.length === 1 ) {
                ...
                return this.each(function() {
                    if ( !$.data( this, 'lbgGauge' ) ) {
                        $.data( this, 'lbgGauge', new lbgGauge( this, options, method ) );
                    }
                });
            }
        } else {
            return this.each(function() {
                if (typeof $.data(this, 'lbgGauge')[method] === 'function') {
                    $.data(this, 'lbgGauge')[method](options);
                }
            });
        }
